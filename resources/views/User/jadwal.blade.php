...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="text-center mb-10">
        <h1 class="text-5xl font-bold text-[#004643] mb-4">Jadwal Piket</h1>
        <p class="text-gray-600 text-lg">Kelola dan pantau jadwal piket harian Anda</p>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-xl p-8 mb-8">
        ...
        <div class="flex justify-between items-center mt-6 text-sm text-gray-500">
            <span id="rowCount">Menampilkan 5 dari 5 jadwal</span>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const jadwalData = [
        ...
        { tanggal: '02/02/2026', hari: 'Selasa', absen: 15, nama: 'Andi Pratama', status: 'Selesai', week: 1 },
        { tanggal: '03/02/2026', hari: 'Rabu', absen: 12, nama: 'Siti Rahma', status: 'Belum Selesai', week: 1 },
        { tanggal: '04/02/2026', hari: 'Kamis', absen: 20, nama: 'Budi Utomo', status: 'Selesai', week: 1 },
        { tanggal: '05/02/2026', hari: 'Jumat', absen: 14, nama: 'Dewi Lestari', status: 'Belum Selesai', week: 1 },
        
        // Minggu Kedua (08-14 Feb)
        { tanggal: '08/02/2026', hari: 'Selasa', absen: 10, nama: 'Fina Aqmei', status: 'Belum Selesai', week: 2 },
        { tanggal: '09/02/2026', hari: 'Rabu', absen: 22, nama: 'Rudi Hermawan', status: 'Selesai', week: 2 },
        { tanggal: '10/02/2026', hari: 'Kamis', absen: 16, nama: 'Anisa Putri', status: 'Selesai', week: 2 },
        { tanggal: '11/02/2026', hari: 'Jumat', absen: 19, nama: 'Hendra Wijaya', status: 'Belum Selesai', week: 2 },
        
        // Minggu Ketiga (15-21 Feb)
        { tanggal: '15/02/2026', hari: 'Rabu', absen: 20, nama: 'Kinandaru Pamudya', status: 'Belum Selesai', week: 3 },
        { tanggal: '16/02/2026', hari: 'Kamis', absen: 24, nama: 'Marvin Al-latif', status: 'Selesai', week: 3 },
        { tanggal: '17/02/2026', hari: 'Jumat', absen: 13, nama: 'Sarah Azzahra', status: 'Selesai', week: 3 },
        
        // Minggu Keempat (22-28 Feb)
        { tanggal: '21/02/2026', hari: 'Jumat', absen: 11, nama: 'Herlambang', status: 'Selesai', week: 4 },
        { tanggal: '22/02/2026', hari: 'Senin', absen: 17, nama: 'Rina Melati', status: 'Belum Selesai', week: 4 },
        { tanggal: '23/02/2026', hari: 'Selasa', absen: 21, nama: 'Agus Salim', status: 'Selesai', week: 4 },
        { tanggal: '24/02/2026', hari: 'Rabu', absen: 23, nama: 'Dian Sastro', status: 'Selesai', week: 4 },
        { tanggal: '25/02/2026', hari: 'Kamis', absen: 14, nama: 'Reza Rahadian', status: 'Belum Selesai', week: 4 },
        { tanggal: '26/02/2026', hari: 'Jumat', absen: 16, nama: 'Ayu Ting Ting', status: 'Selesai', week: 4 }
    ];
    ...
    function getFilteredData() {
        ...
        let filtered = jadwalData.filter(item => item.week === currentWeek);
    ...
    function renderTable() {
            ...
            tableBody.innerHTML = `
                <tr>
                    <td colspan="5" class="py-12 text-center text-gray-500">
                        ...
                        <p class="text-lg font-medium">Tidak ada jadwal</p>
                        <p class="text-sm mt-1">Coba filter lain atau pilih minggu yang berbeda</p>
                    </td>
                </tr>
            `;
            document.getElementById('rowCount').textContent = 'Menampilkan 0 jadwal';
            return;
        }
        ...
        document.getElementById('rowCount').textContent = `Menampilkan ${filteredData.length} jadwal`;
        
        // Update filter info di periode display
        if (currentFilterDay !== 'all' && filteredData.length > 0) {
            // Periode display tetap menampilkan minggu, tidak diubah
        }
    }
